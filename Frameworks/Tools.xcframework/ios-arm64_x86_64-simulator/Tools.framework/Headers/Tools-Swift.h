...
#ifndef TOOLS_SWIFT_H
#define TOOLS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Tools",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface NSData (SWIFT_EXTENSION(Tools))
...
SWIFT_CLASS("_TtC5Tools14SafariActivity")
...
@interface UIColor (SWIFT_EXTENSION(Tools))
...
SWIFT_CLASS("_TtC5Tools24WebBrowserViewController")
...
@interface WebBrowserViewController (SWIFT_EXTENSION(Tools))
...
@interface WebBrowserViewController (SWIFT_EXTENSION(Tools)) <WKUIDelegate>
...
@interface WebBrowserViewController (SWIFT_EXTENSION(Tools)) <WKNavigationDelegate>
